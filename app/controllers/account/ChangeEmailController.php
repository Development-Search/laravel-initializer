...
class ChangeEmailController extends AuthorizedController {
	...
	public function postIndex()
	{
		...
		if ( ! $user->checkPassword(Input::get('current_password')))
		{
			...
			return Redirect::route('account.change-email.index')->withErrors($this->messageBag);
		}
		...
		return Redirect::route('account.change-email.index')->with('success', 'Email successfully updated');
	}
